...
sum(salaries$salary_adjustments) / nrow(salaries)
...
#The salary adjustments are reasonable, the average loss is exactly where I would expect it to be. 
#The average pay raise was a little low given the bounds but not unreasonable.
